...
export default class Blanks extends Component{
	constructor({ element, options, elemInnerRes, data}) {
		...
		let blanks_price_master = data.blanks_price_master
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		    ...
		    menuBar.onmouseover = function(e) {
		      ...
		      tooltipElem.innerHTML = `
			      ...
			      <input class="blanks_change_data" id="input_blanks_price_master" value="${blanks_price_master}"><br>
		      ...
		      let input_blanks_price_master = document.querySelector('#input_blanks_price_master');
				...
				input_blanks_price_master.oninput = () => {
					blanks_price_master = +input_blanks_price_master.value || 5400;
				}
...
//////////////////////////////////////конец события//////////////////////////////////////////////////////////////////////
		...
		button.addEventListener('click', () => {
	    		this._showResult(blakns_price_newspaper, blakns_price_offsetpaper, blakns_paint_gramm, blakns_price_min,
	    		 elemInner, circulation, blanks_price_master)
	    	});
	...
	_printing_time (dataPriceMin, circulation) {
 	...
 	_getCalculatResult (dataNewspaper, dataOffsetPaper, dataPaintGr, dataPriceMin, circulationData, blanks_price_master) {
		 ...
		 this.result = this._result_paint + this._print_time + this._result_cutting 
				 + this._result_paper + this._selectedOptionMaster.value*blanks_price_master
		}

	_showResult (dataNewspaper, dataOffsetPaper, dataPaintGr, dataPriceMin, elemInnerRes, circulationData, blanks_price_master) {
		  this._getCalculatResult(dataNewspaper, dataOffsetPaper, dataPaintGr, dataPriceMin,
		  circulationData, blanks_price_master);
		  ...
		  let blanks_formats = this._element.querySelector('[class="Формат:"]')
			...
			<table>
			  ...
			  <tr>
			    <td>Мастер * ${blanks_price_master} рублей</td>
